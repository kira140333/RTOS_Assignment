...
static void task3_handler(void * pvParameters);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|Blue_LED_Pin|R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin Blue_LED_Pin R_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|Blue_LED_Pin|R_Pin;
